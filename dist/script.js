...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _phoneInputs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./phoneInputs */ "./src/js/modules/phoneInputs.js");
...
const changeModalState = state => {
  ...
  Object(_phoneInputs__WEBPACK_IMPORTED_MODULE_0__["default"])("#height"), Object(_phoneInputs__WEBPACK_IMPORTED_MODULE_0__["default"])("#width");
...
const forms = state => {
  ...
  Object(_phoneInputs__WEBPACK_IMPORTED_MODULE_0__["default"])("input[name='user_phone']");
  const message = {
    loading: "Загрузка..",
...
const modals = state => {
  ...
  // параметр для упарвление подложками с калякулятором
  modalContent = false,
  // для модулей с калулятором для добваление подсказки
  stateObj = false,
  // для проверки объекта на наличие данных
  ...
  bindModal(".popup_calc_button", ".popup_calc_profile", ".popup_calc_profile_close", false, ".popup_calc_content", state, 4);
  bindModal(".popup_calc_profile_button", ".popup_calc_end", ".popup_calc_end_close", false, ".popup_calc_profile_content", state, 5);
...
/* harmony default export */ __webpack_exports__["default"] = (phoneInputs);
